...
│   │   └── enrich.ts             # SunCalc astro + barometer trend + daily-derived aggregates (day high/low, 10-min avg wind speed, max-gust dir) from history
